        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          ...
          >
            <motion.div
              ...
              className="inline-flex items-center gap-2 bg-sand-light px-4 py-2 rounded-full text-[12px] text-plum font-semibold mb-6"
            >
              <motion.span
            ...
            <motion.h1
              ...
              className="text-[42px] sm:text-[52px] lg:text-[68px] leading-[1.05] m-0 font-extrabold text-ink tracking-[-0.025em]"
            >
              Votre chien,
              <br />
            ...
            <motion.p
              variants={item}
              transition={{ duration: 0.6, ease }}
              className="text-[16px] lg:text-[17px] leading-[1.6] text-ink/70 max-w-[480px] mt-6 font-normal"
            >
            ...
            <motion.div
              variants={item}
              transition={{ duration: 0.6, ease }}
              className="flex flex-wrap gap-6 sm:gap-8 mt-10 lg:mt-14"
            >
